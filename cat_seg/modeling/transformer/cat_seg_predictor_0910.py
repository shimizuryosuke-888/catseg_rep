...
# 2.1 import先のAggregator変更
# 修正前
# from .model import Aggregator
# 修正後
# from .model_0909_ppg import Aggregator # 0909_corr_embed_reviewed
# from .model_0909_ppg_sam import Aggregator # 0909_ppg_sam_reviewed
from .model_0910_Swin_review import Aggregator # 0910_Swin_review
# ----------------------------
...
# 2.2 class CATSegPredictor変更
# 修正前
# class CATSegPredictor(nn.Module):
# 修正後
class CATSegPredictor_0910(nn.Module):
    @configurable
    def __init__(
        self,
        *,
