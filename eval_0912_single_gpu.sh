...
#ADE20k-150
python train_net_0909_single_gpu.py --config $config \
 --num-gpus $gpus \
 --dist-url "auto" \
 --eval-only \
...
python train_net_0909_single_gpu.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval/pascal_voc \
...
python train_net_0909_single_gpu.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval/pascal_voc_b \
...
python train_net_0909_single_gpu.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval/pascal_context_59 \
...
python train_net_0909_single_gpu.py --config $config \
 ...
 --dist-url "auto" \
 --eval-only \
 OUTPUT_DIR $output/eval/pascal_context_459 \
